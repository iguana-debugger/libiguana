...
unsigned int parse_source_line(std::string&,
                               ...
                               char**,
                               char*);
void print_error(std::string&, unsigned int, unsigned int, char*, bool);
...
void literal_dump(bool, std::string&, unsigned int);
...
void arm_mnemonic(bool& last_pass,
  ...
  if (first_pass || last_pass || ((token & 0x00008000) != 0)) {
    ...
    switch (token & 0x000F0000) {
      ...
      {
        int cdp_parameters[] = {static_cast<int>(0xFFFFFFF0), 20, 1, 1, 2};
        int mcr_parameters[] = {static_cast<int>(0xFFFFFFF8), 21, 0, 1, 1};
        int mcrr_parameters[] = {static_cast<int>(0xFFFFFFF0), 4, 0, 0, 0};
        int* parameters;
        int CDP;
